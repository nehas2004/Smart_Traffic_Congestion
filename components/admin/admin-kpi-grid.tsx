...
export function AdminKpiGrid({
  ...
  return (
    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-5">
      ...
      <Card className="group relative flex flex-col justify-between rounded-2xl border-[#e8e0d5] bg-white p-4.5 shadow-xs transition-all hover:border-[#c8a97e]/60 hover:shadow-md">
        <div>
          <div className="flex items-center justify-between">
            <span className="text-[11px] font-extrabold uppercase tracking-wider text-[#9e9189]">
              City Congestion Index
            </span>
            <div className="flex size-7.5 items-center justify-center rounded-xl bg-[#2c2825]/5 text-[#2c2825]">
          ...
          <div className="mt-3 flex items-baseline gap-2">
            ...
            <span className="text-[11px] font-bold text-[#9e9189]">Live Index</span>
          </div>
          <p className="mt-1 text-xs text-[#6b625b] leading-relaxed">
            Average across {numCorridors} corridors in {cleanCity}
          </p>
        </div>

        <div className="mt-3.5 border-t border-[#f0ece7] pt-2.5 flex items-center justify-between">
          <p className="font-mono text-[10px] font-bold text-[#a67c52]">
            {congestionChange >= 0 ? `+${congestionChange}%` : `${congestionChange}%`} vs typical hour
          </p>
          <span className="text-[9px] font-medium uppercase tracking-wider text-[#9e9189] bg-[#faf8f5] px-1.5 py-0.5 rounded">
            Live API
          </span>
        </div>
      </Card>
      ...
      <Card className="group relative flex flex-col justify-between rounded-2xl border-[#e8e0d5] bg-white p-4.5 shadow-xs transition-all hover:border-[#c8a97e]/60 hover:shadow-md">
        <div>
          <div className="flex items-center justify-between">
            ...
            <div className="flex size-7.5 items-center justify-center rounded-xl bg-[#a67c52]/10 text-[#a67c52]">
              <TrendingUp className="size-4" />
            </div>
          </div>

          <div className="mt-3 flex items-baseline gap-2">
            <span className="font-mono text-2xl font-black tracking-tight text-[#a67c52]">
              +{peakDelay} min
            </span>
          </div>
        ...
        <div className="mt-3.5 border-t border-[#f0ece7] pt-2.5 flex items-center justify-between">
          <p className="font-mono text-[10px] font-bold text-[#6b625b]">
            Gradient Boosting Horizon: 60m
          </p>
          <span className="text-[9px] font-medium uppercase tracking-wider text-[#a67c52] bg-[#faf6f0] px-1.5 py-0.5 rounded">
            ML Forecast
          </span>
        </div>
      </Card>
          ...
          <div className="mt-3 flex items-baseline gap-2">
            <span
              className={`font-mono text-2xl font-black tracking-tight ${
                criticalCount > 0 ? 'text-rose-600' : 'text-[#2c2825]'
              }`}
            >
              {criticalCount}
            </span>
      ...
      <Card className="group relative flex flex-col justify-between rounded-2xl border-[#e8e0d5] bg-white p-4.5 shadow-xs transition-all hover:border-[#c8a97e]/60 hover:shadow-md">
        ...
        <div className="mt-3.5 border-t border-[#f0ece7] pt-2.5 flex items-center justify-between">
          ...
          <span className="text-[9px] font-medium uppercase tracking-wider text-emerald-700 bg-emerald-50 px-1.5 py-0.5 rounded">
            Test Set
          </span>
        </div>
      </Card>
      ...
      <Link
        ...
        className="group relative flex flex-col justify-between rounded-2xl border border-blue-200/80 bg-linear-to-br from-blue-50/40 via-white to-amber-50/20 p-4.5 shadow-xs transition-all hover:border-blue-500 hover:shadow-md hover:scale-[1.02] cursor-pointer"
      >
        <div>
          <div className="flex items-center justify-between">
            ...
            <div className="flex size-7.5 items-center justify-center rounded-xl bg-blue-600 text-white shadow-xs group-hover:bg-blue-700 transition-colors">
              <Sparkles className="size-4" />
            </div>
          </div>

          <div className="mt-3 flex items-baseline gap-2">
            <span className="font-mono text-2xl font-black tracking-tight text-blue-900">
              {queueCount}
            </span>
            <span className="text-[11px] font-bold text-blue-700">Active</span>
          </div>
          <p className="mt-1 text-xs text-[#6b625b] leading-relaxed">
        ...
        <div className="mt-3.5 border-t border-blue-100 pt-2.5 flex items-center justify-between">
          <p className="text-[10px] font-bold text-blue-700 flex items-center gap-1 group-hover:underline">
            <span>Review in Advisory</span>
            <ArrowRight className="size-3 transition-transform group-hover:translate-x-1" />
          </p>
          <span className="text-[9px] font-extrabold uppercase tracking-wider text-blue-800 bg-blue-100/70 px-1.5 py-0.5 rounded">
            Open Queue
          </span>
        </div>
      </Link>
